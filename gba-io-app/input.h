...
// The VK enum is from https://gist.github.com/lyf-is-coding/2f3806f68d2c2b66f687216e01667a36
// Thanks to @lyf-is-coding for making my life easier!
enum class VK : WORD
{
	NONE = 0x00,
...
enum class EVENTF : DWORD
{
	...
	KEY_KEYDOWN = 0x0000,
	KEY_EXTENDEDKEY = 0x0001,
	KEY_KEYUP = 0x0002,
};

enum class INPUT_TYPE : DWORD
{
	MOUSE = INPUT_MOUSE,
	KEYBOARD = INPUT_KEYBOARD
};

// If the opposite event is the same as the original, then the event is a repeating event instead of a toggling event.
// Which means, the code will not check the previous key feed for the key status change, instead it will continuously send the event.
const std::map<EVENTF, EVENTF> EVENTF_OPPOSITE = {
	{ EVENTF::MOUSE_ABSOLUTE, EVENTF::MOUSE_ABSOLUTE },
	{ EVENTF::MOUSE_LEFTDOWN, EVENTF::MOUSE_LEFTUP },
	{ EVENTF::MOUSE_LEFTUP, EVENTF::MOUSE_LEFTDOWN },
	{ EVENTF::MOUSE_MIDDLEDOWN, EVENTF::MOUSE_MIDDLEUP },
	{ EVENTF::MOUSE_MIDDLEUP, EVENTF::MOUSE_MIDDLEDOWN },
	{ EVENTF::MOUSE_MOVE, EVENTF::MOUSE_MOVE },
	{ EVENTF::MOUSE_RIGHTDOWN, EVENTF::MOUSE_RIGHTUP },
	{ EVENTF::MOUSE_RIGHTUP, EVENTF::MOUSE_RIGHTDOWN },
	{ EVENTF::MOUSE_WHEEL, EVENTF::MOUSE_WHEEL },
	{ EVENTF::MOUSE_XDOWN, EVENTF::MOUSE_XUP },
	{ EVENTF::MOUSE_XUP, EVENTF::MOUSE_XDOWN },
	{ EVENTF::MOUSE_HWHEEL, EVENTF::MOUSE_HWHEEL },

	{ EVENTF::KEY_KEYDOWN, EVENTF::KEY_KEYUP },
	{ EVENTF::KEY_KEYUP, EVENTF::KEY_KEYDOWN },
	{ EVENTF::KEY_EXTENDEDKEY, EVENTF::KEY_EXTENDEDKEY }
};
