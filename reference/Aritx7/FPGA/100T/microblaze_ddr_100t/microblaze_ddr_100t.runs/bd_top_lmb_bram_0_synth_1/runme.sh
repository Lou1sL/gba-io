...
HD_PWD='E:/Projects/Hardware/gba-io/reference/Aritx7/FPGA/100T/microblaze_ddr_100t/microblaze_ddr_100t.runs/bd_top_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_top_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_top_lmb_bram_0.tcl
