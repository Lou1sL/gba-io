...
HD_PWD='E:/Projects/Hardware/gba-io/reference/Aritx7/FPGA/100T/gpif_speed_test/gpif_speed_test.runs/hs_rx_pkt_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hs_rx_pkt_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hs_rx_pkt_fifo.tcl
