...
HD_PWD='E:/Projects/Hardware/gba-io/reference/Aritx7/FPGA/100T/gpif_speed_test/gpif_speed_test.runs/hs_tx_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hs_tx_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hs_tx_fifo.tcl
