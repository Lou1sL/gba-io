...
HD_PWD='F:/workspace/gpif_vfifo/gpif_vfifo.runs/vfifo_rst_mig_7series_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vfifo_rst_mig_7series_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vfifo_rst_mig_7series_0_100M_0.tcl
