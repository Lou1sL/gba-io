...
HD_PWD='E:/Projects/Hardware/gba-io/reference/Aritx7/FPGA/100T/gpif_vfifo/gpif_vfifo.runs/vfifo_mig_7series_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vfifo_mig_7series_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vfifo_mig_7series_0_0.tcl
