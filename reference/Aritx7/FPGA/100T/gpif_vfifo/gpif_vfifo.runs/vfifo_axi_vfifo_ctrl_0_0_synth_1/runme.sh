...
HD_PWD='F:/workspace/gpif_vfifo/gpif_vfifo.runs/vfifo_axi_vfifo_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vfifo_axi_vfifo_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vfifo_axi_vfifo_ctrl_0_0.tcl
