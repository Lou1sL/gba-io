...
HD_PWD='F:/workspace/gpif_vfifo/gpif_vfifo.runs/vfifo_axis_data_fifo_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vfifo_axis_data_fifo_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vfifo_axis_data_fifo_1_0.tcl
